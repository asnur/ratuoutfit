...
<section class="blog-detail-page section-big-py-space ratio2_3">
    <div class="container">
        <div class="row section-big-pb-space">
            <div class="col-sm-12 blog-detail">
               <div class="creative-card">
                   <img src="{{ asset('vendor/themes') }}/images/blog/main.jpg" class="img-fluid w-100 " alt="blog">
        ...
        <div class="row section-big-pb-space blog-advance ">
            <div class="col-lg-6 ">
                    <div class="creative-card">
                        <img src="{{ asset('vendor/themes') }}/images/blog/1.jpg" class="img-fluid " alt="blog">
                        <ul>
            ...
            <div class="col-lg-6 ">
                    <div class="creative-card">
                        <img src="{{ asset('vendor/themes') }}/images/blog/2.jpg" class="img-fluid  " alt="blog">
                        ...
                        <p class="mt-2">Nulla quam turpis, commodo et placerat eu, mollis ut odio. Donec pellentesque egestas consequat. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nunc at urna dolor. Mauris odio nisi,  rhoncus ac justo eget, lacinia iaculis lectus. rhoncus ac justo eget, lacinia iaculis lectus.</p>
                        <p class="mt-2">Nulla quam turpis, commodo et placerat eu, mollis ut odio. Donec pellentesque egestas consequat. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices.</p>
                    </div>
                </div>
        </div>
        <div class="row section-big-pb-space">
            <div class="col-sm-12 ">
                <div class="creative-card">
                    <ul class="comment-section">
                        <li>
                            <div class="media"><img src="{{ asset('vendor/themes') }}/images/avtar/1.jpg" alt="Generic placeholder image">
                        ...
                        <li>
                            <div class="media"><img src="{{ asset('vendor/themes') }}/images/avtar/2.jpg" alt="Generic placeholder image">
                                <div class="media-body">
                                    <h6>Mark Jecno <span>( 12 Jannuary 2018 at 1:30AM )</span></h6>
                                    <p>Donec rhoncus massa quis nibh imperdiet dictum. Vestibulum id est sit amet felis fringilla bibendum at at leo. Proin molestie ac nisi eu laoreet. Integer faucibus enim nec ullamcorper tempor. Aenean nec felis dui.</p>
                                </div>
                        ...
                        <li>
                            <div class="media"><img src="{{ asset('vendor/themes') }}/images/avtar/3.jpg" alt="Generic placeholder image">
                                <div class="media-body">
                                    <h6>Mark Jecno <span>( 12 Jannuary 2018 at 1:30AM )</span></h6>
                                    <p>Donec rhoncus massa quis nibh imperdiet dictum. Vestibulum id est sit amet felis fringilla bibendum at at leo. Proin molestie ac nisi eu laoreet. Integer faucibus enim nec ullamcorper tempor. Aenean nec felis dui.</p>
                                </div>
