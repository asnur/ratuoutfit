      ...
      <div class="custom-container">
        <div class="row">
          <div class="col-sm-3 collection-filter category-page-side">
            ...
            <div class="theme-card creative-card creative-inner mb-5">
                ...
                <div>
                  <div class="media-banner plrb-0 b-g-white1 border-0">
                    <div class="media-banner-box">
                      <div class="media">
                        <a href="product-page(left-sidebar).html" tabindex="0">
                          <img src="{{ asset('vendor/themes') }}/images/layout-2/media-banner/3.jpg" class="img-fluid " alt="banner">
                        </a>
                    ...
                    <div class="media-banner-box">
                      <div class="media">
                        <a href="product-page(left-sidebar).html" tabindex="0">
                          <img src="{{ asset('vendor/themes') }}/images/layout-2/media-banner/1.jpg" class="img-fluid " alt="banner">
                        </a>
                        <div class="media-body">
                          <div class="media-contant">
                            <div>
                    ...
                    <div class="media-banner-box">
                      <div class="media">
                        <a href="product-page(left-sidebar).html" tabindex="0">
                          <img src="{{ asset('vendor/themes') }}/images/layout-2/media-banner/2.jpg" class="img-fluid " alt="banner">
                        </a>
                        <div class="media-body">
                          <div class="media-contant">
                            <div>
                        ...
                        <div class="col-12">
                          <div class="product-filter-content">
                            ...
                            <div class="collection-grid-view">
                              <ul>
                                <li><img src="{{ asset('vendor/themes') }}/images/category/icon/2.png" alt="" class="product-2-layout-view"></li>
                                <li><img src="{{ asset('vendor/themes') }}/images/category/icon/3.png" alt="" class="product-3-layout-view"></li>
                                <li><img src="{{ asset('vendor/themes') }}/images/category/icon/4.png" alt="" class="product-4-layout-view"></li>
                                <li><img src="{{ asset('vendor/themes') }}/images/category/icon/6.png" alt="" class="product-6-layout-view"></li>
                              </ul>
                            </div>
                          ...
                          <div class="product-box">
                            <div class="product-imgbox">
                              <div class="product-front">
                                <a href="product-page(left-sidebar).html"> <img src="{{ asset('vendor/themes') }}/images/layout-4/product/1.jpg" class="img-fluid  " alt="product"> </a>
                              </div>
                              <div class="product-back">
                                <a href="product-page(left-sidebar).html"> <img src="{{ asset('vendor/themes') }}/images/layout-4/product/a1.jpg" class="img-fluid  " alt="product"> </a>
                              </div>
                            </div>
