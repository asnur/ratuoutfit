                ...
                <div class="col-sm-3 collection-filter">
                            ...
                            <div class="collection-collapse-block-content">
                                <div class="collection-brand-filter">
                                    <ul class="category-list">
                                        ...
                                        <li><a href="#">{{ $cate->category_value }}</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="theme-card creative-card creative-inner">
                        ...
                        <div class="slide-1">
                                                ...
                                                <div class="media-contant">
                                                    <div>
                                                        <div class="product-detail">
                                                            <ul class="rating">
                                                                @if($rating->rating($hijab->product_id > 0))
                                                                <?php 
                                                                    for($i=0; $i<floor($rating->rating($hijab->product_id)); $i++){ 
                                                                ?>
                                                                <li><i class="fa fa-star"></i></li>
                                                                <?php
                                                                    }
                                                                    for($i=0; $i< 5-floor($rating->rating($hijab->product_id)); $i++){
                                                                ?>
                                                            ...
                                                            <h6>Rp.{{ number_format($hijab->price - ($hijab->price*($hijab->sale/100))) }} <span>{{ $hijab->price }}</span></h6>
                                                        </div>
                                                        <div class="cart-info">
                            ...
                            <div>
                                <div class="media-banner plrb-0 b-g-white1 border-0">
                                    @foreach($new_product->new_product('Gamis') as $gamis)
                                    <div class="media-banner-box">
                                        <div class="media">
                                            <a href="product-page(left-sidebar).html" tabindex="0">
                                                <img src="{{ asset('vendor/themes') }}/images/product/{{ $gamis->cover }}"
                                                    class="img-fluid " width="120" alt="banner">
                                            </a>
                                            <div class="media-body">
                                                <div class="media-contant">
                                                    <div>
                                                        <div class="product-detail">
                                                            <ul class="rating">
                                                                @if($rating->rating($gamis->product_id > 0))
                                                                <?php 
                                                                    for($i=0; $i<floor($rating->rating($gamis->product_id)); $i++){ 
                                                                ?>
                                                                <li><i class="fa fa-star"></i></li>
                                                                <?php
                                                                    }
                                                                    for($i=0; $i< 5-floor($rating->rating($gamis->product_id)); $i++){
                                                                ?>
                                                                <li><i class="fa fa-star-o"></i></li>
                                                                <?php } ?>
                                                                @else
                                                            ...
                                                            <h6>Rp.{{ number_format($gamis->price - ($gamis->price*($gamis->sale/100))) }} <span>{{ $gamis->price }}</span></h6>
                                                        </div>
                                                        <div class="cart-info">
                                                            <button class="tooltip-top add-cartnoty"
                                                                data-tippy-content="Add to cart"> <svg
                    ...
                    <div class="row ">
                        <div class="col-lg-5">
                            <div class="product-slick ">
                                ...
                                <div><img src="{{ asset('vendor/themes') }}/images/product/{{ $p->picture_name }}"
                                        alt="" class="img-fluid  image_zoom_cls"
                                        style="height: 450px; object-fit:cover;"></div>
                                @endforeach
                            </div>
                            <div class="row">
                                <div class="col-12 p-0">
                                    <div class="slider-nav">
                                        @foreach ($picture as $p)
                                        <div><img
                                                src="{{ asset('vendor/themes') }}/images/product/{{ $p->picture_name }}"
                                                alt="" style="height: 150px; object-fit:cover;" class="img-fluid">
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12 col-lg-12">
                                ...
                                <div class="tab-content nav-material" id="top-tabContent">
                                    ...
                                    <div class="tab-pane fade" id="top-profile" role="tabpanel"
                                        ...
                                        <p class="pl-0">Lorem Ipsum is simply dummy text of the printing and typesetting
                                ...
                                <div class="detail-title">
                                    <div class="detail-left">
                                       <div class="rating-star">
                                                                @if($rating->rating($relate->product_id > 0))
                                                                <?php 
                                                                    for($i=0; $i<floor($rating->rating($relate->product_id)); $i++){ 
                                                                ?>
                                                                <i class="fa fa-star"></i>
                                                                <?php
                                                                    }
                                                                    for($i=0; $i<= 5-floor($rating->rating($relate->product_id)); $i++){
                                                                ?>
                                    ...
                                    <div class="detail-right">
                                        ...
                                        <div class="price">
                                            <div class="price">
                                                Rp.{{ number_format($relate->price-($relate->price*($relate->sale/100))) }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="modal-bg addtocart">
                                ...
                                <div class="media">
                                    <a href="javascript:void(0)">
                                        <img src="{{ asset('vendor/themes') }}/images/layout-4/product/3.jpg"
                                    ...
                                    <div class="media-body align-self-center text-center">
                                        ...
                                        <div class="upsell_payment">
                                            <img src="{{ asset('vendor/themes') }}/images/paymat.png" class="img-fluid "
                                    ...
                                    <div class="row" id="upsell_product">
                                        <div class="product-box col-sm-3 col-6">
                                            <div class="img-wrapper">
                                                <div class="front">
                                                    <a href="product-page(left-sidebar).html">
                                                        <img src="{{ asset('vendor/themes') }}/images/layout-4/product/1.jpg"
                                        ...
                                        <div class="product-box col-sm-3 col-6">
                                            <div class="img-wrapper">
                                                <div class="front">
                                                    <a href="product-page(left-sidebar).html">
                                                        <img src="{{ asset('vendor/themes') }}/images/layout-4/product/2.jpg"
                                                            class="img-fluid blur-up lazyload mb-1" alt="cotton top">
                                                    </a>
                                                </div>
                                                <div class="product-detail">
                                        ...
                                        <div class="product-box col-sm-3 col-6">
                                            <div class="img-wrapper">
                                                <div class="front">
                                                    <a href="product-page(left-sidebar).html">
                                                        <img src="{{ asset('vendor/themes') }}/images/layout-4/product/a1.jpg"
                                                            class="img-fluid blur-up lazyload mb-1" alt="cotton top">
                                                    </a>
                                                </div>
                                                <div class="product-detail">
                                        ...
                                        <div class="product-box col-sm-3 col-6">
                                            <div class="img-wrapper">
                                                <div class="front">
                                                    <a href="product-page(left-sidebar).html">
                                                        <img src="{{ asset('vendor/themes') }}/images/layout-4/product/a2.jpg"
                                                            class="img-fluid blur-up lazyload mb-1" alt="cotton top">
                                                    </a>
                                                </div>
                                                <div class="product-detail">
