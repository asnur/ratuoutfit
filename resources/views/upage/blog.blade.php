        ...
        <div class="row">
                ...
                <div class="blog-sidebar">
                    <div class="theme-card">
                        ...
                        <ul class="recent-blog">
                            <li>
                                <div class="media"><img class="img-fluid " src="{{ asset('vendor/themes') }}/images/blog/1.jpg" alt="Generic placeholder image">
                            ...
                            <li>
                                <div class="media"><img class="img-fluid " src="{{ asset('vendor/themes') }}/images/blog/2.jpg" alt="Generic placeholder image">
                                    <div class="media-body align-self-center">
                                        <h6>25 Dec 2018</h6>
                                        <p>0 hits</p>
                                    </div>
                            ...
                            <li>
                                <div class="media"><img class="img-fluid " src="{{ asset('vendor/themes') }}/images/blog/3.jpg" alt="Generic placeholder image">
                                    <div class="media-body align-self-center">
                                        <h6>25 Dec 2018</h6>
                                        <p>0 hits</p>
                                    </div>
                            ...
                            <li>
                                <div class="media"><img class="img-fluid " src="{{ asset('vendor/themes') }}/images/blog/4.jpg" alt="Generic placeholder image">
                                    <div class="media-body align-self-center">
                                        <h6>25 Dec 2018</h6>
                                        <p>0 hits</p>
                                    </div>
                            ...
                            <li>
                                <div class="media"><img class="img-fluid " src="{{ asset('vendor/themes') }}/images/blog/5.jpg" alt="Generic placeholder image">
                                    <div class="media-body align-self-center">
                                        <h6>25 Dec 2018</h6>
                                        <p>0 hits</p>
                                    </div>
            ...
            <div class="col-xl-9 col-lg-8 col-md-7 order-sec">
                <div class="row blog-media">
                    <div class="col-xl-6 ">
                        <div class="blog-left">
                            <a href="javascript:void(0)"><img src="{{ asset('vendor/themes') }}/images/blog/1.jpg" class="img-fluid  " alt="blog-left"></a>
                    ...
                    <div class="col-xl-6 ">
                        <div class="blog-right">
                            <div>
                                <a href="javascript:void(0)"><h4>you how all this mistaken idea of denouncing pleasure and praising pain was born.</h4></a>
                ...
                <div class="row blog-media">
                    <div class="col-xl-6 ">
                        <div class="blog-left">
                            <a href="javascript:void(0)"><img src="{{ asset('vendor/themes') }}/images/blog/2.jpg" class="img-fluid  " alt=""></a>
                            <div class="date-label">
                                26 nov 2019
                            </div>
                        </div>
                ...
                <div class="row blog-media">
                    <div class="col-xl-6 ">
                        <div class="blog-left">
                            <a href="javascript:void(0)"><img src="{{ asset('vendor/themes') }}/images/blog/3.jpg" class="img-fluid  " alt=""></a>
                            <div class="date-label">
                                26 nov 2019
                            </div>
                        </div>
                ...
                <div class="row blog-media">
                    <div class="col-xl-6 ">
                        <div class="blog-left">
                            <a href="javascript:void(0)"><img src="{{ asset('vendor/themes') }}/images/blog/4.jpg" class="img-fluid  " alt=""></a>
                            <div class="date-label">
                                26 nov 2019
                            </div>
                        </div>
        ...
        <div class="news-latter">
          <div class="modal-bg">
            ...
            <div class="imd-wrraper">
                <img src="{{ asset('vendor/themes') }}/images/layout-2/product/3.jpg" alt="newsletterimg" class="img-fluid bg-img">
            </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6 col-xs-12">
            <div class="quick-view-img">
              <img src="{{ asset('vendor/themes') }}/images/layout-1/product/3.jpg" alt="" class="img-fluid bg-img">
            </div>
          </div>
                ...
                <div class="modal fade" id="sizemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body"><img src="{{ asset('vendor/themes') }}/images/size-chart.jpg" alt="" class="img-fluid "></div>
                    </div>
                  </div>
                </div>
                <div class="size-box">
    ...
    <div class="cart_media">
      <ul class="cart_product">
        <li>
          <div class="media">
            <a href="product-page(left-sidebar).html">
              <img alt="megastore1" class="me-3" src="{{ asset('vendor/themes') }}/images/layout-2/product/1.jpg">
            </a>
            <div class="media-body">
              <a href="product-page(left-sidebar).html">
                <h4>redmi not 3</h4>
        ...
        <li>
          <div class="media">
            <a href="product-page(left-sidebar).html">
              <img alt="megastore1" class="me-3" src="{{ asset('vendor/themes') }}/images/layout-2/product/2.jpg">
            </a>
            <div class="media-body">
              <a href="product-page(left-sidebar).html">
        ...
        <li>
          <div class="media">
            <a href="product-page(left-sidebar).html">
              <img alt="megastore1" class="me-3" src="{{ asset('vendor/themes') }}/images/layout-2/product/3.jpg">
            </a>
            <div class="media-body">
              <a href="product-page(left-sidebar).html">
