                        ...
                        <div class="footer-box">
                            ...
                            <div class="footer-contant">
                                <div class="footer-logo">
                                    <a href="index.html">
                                        <img src="{{ asset('vendor/themes') }}/images/layout-2/logo/logo.png"
                                ...
                                <ul class="paymant">
                                    <li><a href="javascript:void(0)"><img
                                                src="{{ asset('vendor/themes') }}/images/layout-1/pay/1.png"
                                                class="img-fluid" alt="pay"></a></li>
                                    <li><a href="javascript:void(0)"><img
                                                src="{{ asset('vendor/themes') }}/images/layout-1/pay/2.png"
                                                class="img-fluid" alt="pay"></a></li>
                                    <li><a href="javascript:void(0)"><img
                                                src="{{ asset('vendor/themes') }}/images/layout-1/pay/3.png"
                                                class="img-fluid" alt="pay"></a></li>
                                    <li><a href="javascript:void(0)"><img
                                                src="{{ asset('vendor/themes') }}/images/layout-1/pay/4.png"
                                                class="img-fluid" alt="pay"></a></li>
                                    <li><a href="javascript:void(0)"><img
                                                src="{{ asset('vendor/themes') }}/images/layout-1/pay/5.png"
                                                class="img-fluid" alt="pay"></a></li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-6 col-md-8 col-sm-12">
                    <div class="footer-left">
                        <p>{{ date('Y') }} COPYRIGHT RATUOUTFIT.COM</p>
                    </div>
                </div>
