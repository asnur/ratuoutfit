...
<div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel"
    ...
    <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="10000">
            <img src="{{ asset('vendor/themes') }}/images/layout-2/slider/slider1.jpg"
                style="object-fit: cover; overflow:hidden;" class="d-block w-100" alt="...">
        </div>
...
<section class="collection-banner section-pt-space b-g-white ">
    <div class="custom-container">
        <div class="row collection2">
            <div class="col-md-4">
                <div class="collection-banner-main banner-1 p-right" style="background: red;">
                    <div class="collection-img">
                        <img src="{{ asset('vendor/themes') }}/images/layout-2/collection-banner/1.jpg"
            ...
            <div class="col-md-4">
                <div class="collection-banner-main banner-1 p-right">
                    <div class="collection-img">
                        <img src="{{ asset('vendor/themes') }}/images/layout-2/collection-banner/2.jpg"
                            class="img-fluid bg-img  " alt="banner">
                    </div>
                    <div class="collection-banner-contain ">
                        <div>
            ...
            <div class="col-md-4">
                <div class="collection-banner-main banner-1 p-right">
                    <div class="collection-img">
                        <img src="{{ asset('vendor/themes') }}/images/layout-2/collection-banner/3.jpg"
                            class="img-fluid bg-img  " alt="banner">
                    </div>
                    <div class="collection-banner-contain ">
                        <div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="discount-banner-contain">
                    <h2>Discount Hanya di Toko Kami.</h2>
                    <h1><span>OMG! Diskon Murah</span> <span>Hanya di Toko Kamu!</span></h1>
                    <div class="rounded-contain rounded-inverse">
                        <div class="rounded-subcontain">
                            Bagaimana Cara Saya Mendapatkan diskon nya? Ayo Simak
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col">
                <div class="collection-banner-main banner-5 p-center">
                    <div class="collection-img">
                        <img src="{{ asset('vendor/themes') }}/images/layout-2/collection-banner/7.jpg" class="bg-img  "
                            alt="banner">
                    </div>
                    <div class="collection-banner-contain ">
        ...
        <div class="row">
            <div class="col">
                <div class="slide-6 no-arrow">
                    @foreach ($category as $cate_slick)
                    <div>
                        <div class="category-contain">
                            <div class="img-wrapper">
                                <a href="category-page(left-sidebar).html">
                                    <img src="{{ asset('vendor/themes') }}/images/layout-2/category/{{ $cate_slick->category->picture }}"
                                        alt="category" class="img-fluid" style="width:100%;height:auto;">
                                </a>
                            </div>
                            <a href="category-page(left-sidebar).html" class="btn-rounded">
                                {{ $cate_slick->category->category_value }}
                            </a>
                        </div>
                    </div>
                    @endforeach
        ...
        <div class="row">
            ...
            <div class="col-6 col-sm-3">
                <div class="card my-3" style="border-radius:20px;">
                    <img src="{{ asset('vendor/themes') }}/images/product/{{ $dp->cover }}" class="card-img-top" alt="{{ asset('vendor/themes') }}/images/product/{{ $dp->cover }}" style="height: 380px; object-fit:cover; object-possition: center;border-top-left-radius:20px; border-top-right-radius: 20px">
                    <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6">
                                        <div class="detail-left">
                                            ...
                                            <a href="product-page(left-sidebar).html">
                                                <h6 class="price-title fs-6" style="font-weight:600;color:#000000;">
                                                    {{ $dp->name }}
                                                </h6>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 text-end py-0">
                                        <div class="">
                                            <div class="check-price mb-2" style="text-decoration:line-through;">
                                                Rp.{{ number_format($dp->price) }}
                                            </div>
                                            <div class="price fs-6">
...
<!--collection banner start-->
<section class="collection-banner section-pt-space b-g-white mb-3">
    <div class="custom-container">
        <div class="row collection2">
            <div class="col-md-4">
                <div class="collection-banner-main banner-1 p-right" style="background: red;">
    ...
    <div class="tab-product-main">
        <div class="tab-prodcut-contain">
            <ul class="tabs tab-title">
                ...
                font-weight: 700;
                font-size: calc(14px + (18 - 14) * ((100vw - 320px) / (1920 - 320))); cursor:pointer;"># Instagram</li>
            </ul>
        </div>
    </div>
</section>
                        ...
                        <div class="slide-7 no-arrow">
                            <div>
                                <div class="instagram-box">
                                    <img src="{{ asset('vendor/themes') }}/images/insta/1.jpg"
                                        style="height: 273px; width: 273px; object-fit:cover;" class="img-fluid  "
                                        alt="insta">
                            ...
                            <div>
                                <div class="instagram-box">
                                    <img src="{{ asset('vendor/themes') }}/images/insta/2.jpg"
                                        style="height: 273px; width: 273px; object-fit:cover;" class="img-fluid  "
                                        alt="insta">
                                    <div class="insta-cover">
                                        <i class="fa fa-instagram"></i>
                            ...
                            <div>
                                <div class="instagram-box">
                                    <img src="{{ asset('vendor/themes') }}/images/insta/3.jpg"
                                        style="height: 273px; width: 273px; object-fit:cover;" class="img-fluid  "
                                        alt="insta">
                                    <div class="insta-cover">
                                        <i class="fa fa-instagram"></i>
                            ...
                            <div>
                                <div class="instagram-box">
                                    <img src="{{ asset('vendor/themes') }}/images/insta/4.jpg"
                                        style="height: 273px; width: 273px; object-fit:cover;" class="img-fluid  "
                                        alt="insta">
                                    <div class="insta-cover">
                                        <i class="fa fa-instagram"></i>
                            ...
                            <div>
                                <div class="instagram-box">
                                    <img src="{{ asset('vendor/themes') }}/images/insta/5.jpg"
                                        style="height: 273px; width: 273px; object-fit:cover;" class="img-fluid  "
                                        alt="insta">
                                    <div class="insta-cover">
                                        <i class="fa fa-instagram"></i>
                            ...
                            <div>
                                <div class="instagram-box">
                                    <img src="{{ asset('vendor/themes') }}/images/insta/6.jpg"
                                        style="height: 273px; width: 273px; object-fit:cover;" class="img-fluid  "
                                        alt="insta">
                                    <div class="insta-cover">
                                        <i class="fa fa-instagram"></i>
                            ...
                            <div>
                                <div class="instagram-box">
                                    <img src="{{ asset('vendor/themes') }}/images/insta/7.jpg"
                                        style="height: 273px; width: 273px; object-fit:cover;" class="img-fluid  "
                                        alt="insta">
                                    <div class="insta-cover">
                                        <i class="fa fa-instagram"></i>
                            ...
                            <div>
                                <div class="instagram-box">
                                    <img src="{{ asset('vendor/themes') }}/images/insta/8.jpg"
                                        style="height: 273px; width: 273px; object-fit:cover;" class="img-fluid  "
                                        alt="insta">
                                    <div class="insta-cover">
                                        <i class="fa fa-instagram"></i>
                            ...
                            <div class="row hot-deal-subcontain hotdeal-block1">
                                    ...
                                    <div class="hotdeal-right-slick border-0">
                                        <a href="product-page(left-sidebar).html">
                                            <div class="img-wrraper">
                                                <div>
                                                    <img src="{{ asset('vendor/themes') }}/images/layout-2/hot-deal/8.jpg"
                                        ...
                                        <a href="product-page(left-sidebar).html">
                                            <div class="img-wrraper">
                                                <div>
                                                    <img src="{{ asset('vendor/themes') }}/images/layout-2/hot-deal/7.jpg"
                                                        alt="hot-deal" class="img-fluid  bg-img">
                                                </div>
                                            </div>
                                        </a>
                                        <a href="product-page(left-sidebar).html">
                                            <div class="img-wrraper">
                                                <div>
                                                    <img src="{{ asset('vendor/themes') }}/images/layout-2/hot-deal/6.jpg"
                                                        alt="hot-deal" class="img-fluid  bg-img">
                                                </div>
                                            </div>
                                        </a>
                                        <a href="product-page(left-sidebar).html">
                                            <div class="img-wrraper">
                                                <div>
                                                    <img src="{{ asset('vendor/themes') }}/images/layout-2/hot-deal/5.jpg"
                                                        alt="hot-deal" class="img-fluid  bg-img">
                                                </div>
                                            </div>
                                        </a>
                                        ...
                                        <div>
                                            <div>
                                                ...
                                                <p>
                                                    ...
                                                    reader. It is a long established fact that a reader.
                                                </p>
                                ...
                                <div class="col-md-2 ">
                                    <div class="hotdeal-right-nav">
                                        <div><img src="{{ asset('vendor/themes') }}/images/layout-2/hot-deal/8.jpg"
                                                alt="hot-dea" class="img-fluid  "></div>
                                        <div><img src="{{ asset('vendor/themes') }}/images/layout-2/hot-deal/7.jpg"
                                                alt="hot-dea" class="img-fluid  "></div>
                                        <div><img src="{{ asset('vendor/themes') }}/images/layout-2/hot-deal/6.jpg"
                                                alt="hot-dea" class="img-fluid  "></div>
                                        <div><img src="{{ asset('vendor/themes') }}/images/layout-2/hot-deal/5.jpg"
                                                alt="hot-dea" class="img-fluid  "></div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div>
                        <div class="media-banner border-0">
                            ...
                            <div class="media-banner-box">
                                <div class="media">
                                    <a href="product-page(left-sidebar).html">
                                        <img src="{{ asset('vendor/themes') }}/images/layout-2/media-banner/1.jpg"
                            ...
                            <div class="media-banner-box">
                                <div class="media">
                                    <a href="product-page(left-sidebar).html">
                                        <img src="{{ asset('vendor/themes') }}/images/layout-2/media-banner/2.jpg"
                                            class="img-fluid " alt="banner">
                                    </a>
                                    <div class="media-body">
                                        <div class="media-contant">
                            ...
                            <div class="media-banner-box">
                                <div class="media">
                                    <a href="product-page(left-sidebar).html">
                                        <img src="{{ asset('vendor/themes') }}/images/layout-2/media-banner/3.jpg"
                                            class="img-fluid " alt="banner">
                                    </a>
                                    <div class="media-body">
                                        <div class="media-contant">
                ...
                <div class="slide-1 no-arrow">
                        ...
                        <div class="testimonial-contain">
                            <div class="media">
                                <div class="testimonial-img">
                                    <img src="{{ asset('vendor/themes') }}/images/testimonial/1.jpg"
                    ...
                    <div>
                        <div class="testimonial-contain">
                            <div class="media">
                                <div class="testimonial-img">
                                    <img src="{{ asset('vendor/themes') }}/images/testimonial/2.jpg"
                                        class="img-fluid rounded-circle  " alt="testimonial">
                                </div>
                                <div class="media-body">
                                    <h5>mark jecno</h5>
                    ...
                    <div>
                        <div class="testimonial-contain">
                            <div class="media">
                                <div class="testimonial-img">
                                    <img src="{{ asset('vendor/themes') }}/images/testimonial/3.jpg"
                                        class="img-fluid rounded-circle  " alt="testimonial">
                                </div>
                                <div class="media-body">
                                    <h5>mark jecno</h5>
    ...
    <div class="tab-product-main">
        <div class="tab-prodcut-contain">
            <ul class="tabs tab-title">
                ...
                text-transform: uppercase;
                font-weight: 700;
                font-size: calc(14px + (18 - 14) * ((100vw - 320px) / (1920 - 320))); cursor:pointer;">Kontak Form</li>
            </ul>
        </div>
    </div>
</section>
<section class="product section-pb-space mt-3">
    <div class="custom-container">
        <div class="container">
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="section p-5">
                                <form>
                                    <div class="row">
                                        <div class="col">
                                            <div class="mb-3">
                                                <label for="exampleInputEmail1" class="form-label" style="color: #ea86b6;
                                                text-transform: uppercase;
                                                font-weight: 700;
                                                font-size: 12px">Username</label>
                                                <input type="text" class="form-control rounded-pill" id="exampleInputEmail1" aria-describedby="emailHelp">
                                              </div>
                                        </div>
                                        <div class="col">
                                            <div class="mb-3">
                                                <label for="exampleInputPassword1" class="form-label" style="color: #ea86b6;
                                                text-transform: uppercase;
                                                font-weight: 700;
                                                font-size: 12px">Email</label>
                                                <input type="email" class="form-control rounded-pill" id="exampleInputPassword1">
                                              </div>    
                                        </div>
                                    </div>
                                    <textarea name="" id="" cols="30" rows="10" class="form-control" style="border-radius:20px;" placeholder="Sampaikan pesan untuk admin"></textarea>
                                    <button type="submit" class="btn btn-normal rounded-3 mt-3">Submit</button>
                                </form>
                            </div>
                        </div>
                        <div class="col-md-6 custom-right"></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="modal-bg">
                        <div class="newslatter-main">
                            ...
                            <div class="imd-wrraper">
                                <img src="{{ asset('vendor/themes') }}/images/subscribe/1.jpg" alt="newsletterimg"
                ...
                <div class="row">
                    <div class="col-lg-6 col-xs-12">
                        <div class="quick-view-img">
                            <img src="{{ asset('vendor/themes') }}/images/layout-1/product/3.jpg" alt=""
                                class="img-fluid bg-img">
                        </div>
                    </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body"><img
                                                    src="{{ asset('vendor/themes') }}/images/size-chart.jpg" alt=""
                                                    class="img-fluid "></div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="product-img">
                        <div class="media">
                            <div class="img-wraper">
                                <a href="product-page(left-sidebar).html">
                                    <img src="{{ asset('vendor/themes') }}/images/layout-2/product/1.jpg" alt="">
                                </a>
                            </div>
                            <div class="media-body">
                                <a href="product-page(left-sidebar).html">
